function kubectl_status
  ...
  if [ ! -f $config ]
    # echo (set_color white)$KUBECTL_PROMPT_ICON
    return
  end
  ...
  echo (set_color blue)$KUBECTL_PROMPT_ICON" "(set_color brblue)$ns(set_color white)$KUBECTL_PROMPT_SEPARATOR(set_color blue)$ctx(set_color normal)
end
