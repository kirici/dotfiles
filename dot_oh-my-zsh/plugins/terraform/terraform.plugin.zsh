...
alias tfautod='terraform apply -destroy -auto-approve'
alias tfsauto='sudo terraform apply -auto-approve'
alias tfsautod='sudo terraform apply -destroy -auto-approve'
